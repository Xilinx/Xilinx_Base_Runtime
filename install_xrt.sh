...
usage() {
  echo "Usage:"
  echo "./install_xrt.sh     --platform <platform> --version <version> --os-version <os-version>"
  echo "./install_xrt.sh      -p        <platform>  -v       <version>  -o          <os-version>"
...
./install.sh -x -p $PLATFORM -v $VERSION -o $OSVERSION
